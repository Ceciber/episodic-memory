...
# The CharacterEmbedding class remains the same. It still handles character-level embeddings using CNN-based methods
...
class Embedding(nn.Module):
    def __init__(
        # we discard the variables used to handle Glove embeddings
        self,
        # num_words,
        num_chars,
        # word_dim,
